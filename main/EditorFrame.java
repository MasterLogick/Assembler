...
public class EditorFrame extends JFrame {
    ...
    private static void init() {
        ...
        JButton run = new JButton(new ImageIcon("C:\\Assembler\\img\\run.png"));
        ...
        run.setForeground(Colors.MAIN_FOREGROUND_COLOR);
        run.setBackground(Colors.MAIN_BACKGROUND_COLOR);
        main.setForeground(Colors.MAIN_FOREGROUND_COLOR);
        main.setBackground(Colors.MAIN_BACKGROUND_COLOR);
